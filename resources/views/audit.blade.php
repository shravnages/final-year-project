...
<div class="card" id="digipounds">
</div>
<div class="card">
Updated in real time. Last transaction on {{$date}}.
</div>
...
<script>
    ...
    token.balanceOf.call(accountAddress, function(err, bal) {
        if (!err) {
            ...
            balance = Math.round(100000000 - balance); //total supply
            document.getElementById("digipounds").innerText = balance + " DGP issued.";
        }
    });
</script>
